...
#define UMOUNT_SYSCALL_OFFSET           (0x2BAE10 + 0x8) // SYSCALL (838) + 8 -> peek(SYSCALL_BASE + 838*8) -> peek(0x363BE0 + 0x1A30)
...
static inline void remove_lv2_memcpy()
{
    ...
    /* restore syscall */
    //remove_new_poke();
// Found @ 0x2BC6FC This is per FW, syscall_rmdir_desc // SC813
